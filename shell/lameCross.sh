#!/bin/bash
NDK_ROOT=/home/kingpei/android-ndk-10
...
export PATH=$PATH:$PREBULT/bin:$PLATFORM/usr/include:

export LDFLAGS="-march=armv7-a -L$PLATFORM/usr/lib -L$PREBUILT/arm-linux-androideabi/lib"
export CFLAGS="-march=armv7-a -I$PLATFORM/usr/include -mfloat-abi=softfp -mfpu=vfp -ffast-math -O2"
